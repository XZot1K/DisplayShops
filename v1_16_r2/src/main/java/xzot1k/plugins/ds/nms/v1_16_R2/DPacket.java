 ...
 *  net.minecraft.server.v1_16_R2.EntityArmorStand
 *  net.minecraft.server.v1_16_R2.EntityItem
 *  net.minecraft.server.v1_16_R2.EntityLiving
 *  net.minecraft.server.v1_16_R2.EnumItemSlot
 ...
 *  net.minecraft.server.v1_16_R2.PacketPlayOutEntityDestroy
 *  net.minecraft.server.v1_16_R2.PacketPlayOutEntityEquipment
 *  net.minecraft.server.v1_16_R2.PacketPlayOutEntityMetadata
 *  net.minecraft.server.v1_16_R2.PacketPlayOutEntityVelocity
 *  net.minecraft.server.v1_16_R2.PacketPlayOutSpawnEntity
 *  net.minecraft.server.v1_16_R2.PacketPlayOutSpawnEntityLiving
 *  net.minecraft.server.v1_16_R2.PlayerConnection
 *  net.minecraft.server.v1_16_R2.Vec3D
 *  net.minecraft.server.v1_16_R2.Vector3f
 ...
 */
package xzot1k.plugins.ds.nms.v1_16_R2;
...
public class DPacket implements DisplayPacket {
    ...
    private net.minecraft.server.v1_16_R2.ItemStack itemStack;
    ...
    public DPacket(@NotNull DisplayShops pluginInstance, @NotNull Player player, @NotNull Shop shop, boolean showHolograms) {
        ...
        ItemStack item = shop.getShopItem() != null ? shop.getShopItem().clone() : this.getPluginInstance().getConfig().getBoolean("empty-shop-item") ? new ItemStack(Material.BARRIER) : null;
        if (item != null) {
            ...
            if (item.getType() != Material.AIR) {
                ...
                if (itemStack != null) {
                    ...
                    if (itemStack != null) {
                        ...
                        final DataWatcherSerializer<net.minecraft.server.v1_16_R2.ItemStack> ITEM_STACK_SERIALIZER = DataWatcherRegistry.g;
                        ...
                        final int vehicleId = createStand(playerConnection, x, (y + 1.325), z, "", false);
