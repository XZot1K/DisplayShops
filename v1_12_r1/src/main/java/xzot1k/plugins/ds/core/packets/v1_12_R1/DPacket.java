            ...
            if (item.getType() != Material.AIR) {
                ...
                if (itemStack != null) {
                    ...
                    if (itemStack != null) {
                        ...
                        final DataWatcherSerializer<net.minecraft.server.v1_12_R1.ItemStack> ITEM_STACK_SERIALIZER = DataWatcherRegistry.f;
