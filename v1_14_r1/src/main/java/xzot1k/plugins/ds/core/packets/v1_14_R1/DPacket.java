 ...
 *  net.minecraft.server.v1_14_R1.EntityArmorStand
 *  net.minecraft.server.v1_14_R1.EntityItem
 *  net.minecraft.server.v1_14_R1.EntityLiving
 *  net.minecraft.server.v1_14_R1.EnumItemSlot
 *  net.minecraft.server.v1_14_R1.IChatBaseComponent$ChatSerializer
 *  net.minecraft.server.v1_14_R1.ItemStack
 *  net.minecraft.server.v1_14_R1.Packet
 ...
 *  net.minecraft.server.v1_14_R1.Vec3D
 *  net.minecraft.server.v1_14_R1.Vector3f
 ...
 */
package xzot1k.plugins.ds.core.packets.v1_14_R1;
...
public class DPacket implements DisplayPacket {
    ...
    public DPacket(@NotNull DisplayShops pluginInstance, @NotNull Player player, @NotNull Shop shop, boolean showHolograms) {
            ...
            if (item.getType() != Material.AIR) {
                ...
                if (itemStack != null) {
                    ...
                    if (itemStack != null) {
                        ...
                        final DataWatcherSerializer<net.minecraft.server.v1_14_R1.ItemStack> ITEM_STACK_SERIALIZER = DataWatcherRegistry.g;
        ...
        List<String> hologramFormat = shop.getShopItem() != null ? (shop.getOwnerUniqueId() == null ? this.getPluginInstance().getConfig().getStringList("admin-shop-format")
                : this.getPluginInstance().getConfig().getStringList("valid-item-format")) : (shop.getOwnerUniqueId() == null
                ? this.getPluginInstance().getConfig().getStringList("admin-invalid-item-format") : this.getPluginInstance().getConfig().getStringList("invalid-item-format"));
