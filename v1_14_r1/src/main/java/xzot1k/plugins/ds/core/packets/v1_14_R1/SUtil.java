    ...
    public ItemStack toItem(@NotNull String itemString) {
        ...
        if (!itemString.contains("item:"))
            try {
                ...
                Constructor<?> constructor = net.minecraft.server.v1_14_R1.ItemStack.class.getDeclaredConstructor(NBTTagCompound.class);
                constructor.setAccessible(true);

                return CraftItemStack.asBukkitCopy((net.minecraft.server.v1_14_R1.ItemStack) constructor.newInstance(tag));
