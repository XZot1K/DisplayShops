...
package xzot1k.plugins.ds.core.packets.v1_16_R3;
    ...
    public DPacket(@NotNull DisplayShops pluginInstance, @NotNull Player player, @NotNull Shop shop, boolean showHolograms) {
            ...
            if (item.getType() != Material.AIR) {
                ...
                if (itemStack != null) {
                    ...
                    if (itemStack != null) {
                        ...
                        final DataWatcherSerializer<net.minecraft.server.v1_16_R3.ItemStack> ITEM_STACK_SERIALIZER = DataWatcherRegistry.g;
        ...
        for (int i = hologramFormat.size(); --i >= 0; ) {
            ...
            if (line.contains("{buy-price}") && shop.getBuyPrice(true) < 0.0 || line.contains("{sell-price}")
                    && shop.getSellPrice(true) < 0.0 || line.contains("{description}") && (shop.getDescription() == null
                    || shop.getDescription().equalsIgnoreCase(""))) continue;
