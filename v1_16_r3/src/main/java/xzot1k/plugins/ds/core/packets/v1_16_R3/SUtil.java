...
public class SUtil implements SerializeUtil {
    ...
    public ItemStack toItem(@NotNull String itemString) {
        ...
        if (!itemString.contains("item:"))
            try {
                ...
                Constructor<?> constructor = net.minecraft.server.v1_16_R3.ItemStack.class.getDeclaredConstructor(NBTTagCompound.class);
                constructor.setAccessible(true);

                return CraftItemStack.asBukkitCopy((net.minecraft.server.v1_16_R3.ItemStack) constructor.newInstance(tag));
    ...
    public String toJSON(@NotNull ItemStack itemStack) {
        final net.minecraft.server.v1_16_R3.ItemStack item = CraftItemStack.asNMSCopy(itemStack);
