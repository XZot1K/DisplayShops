...
public class DDataPack implements DataPack {
     ...
     */
    @Override
    public HashMap<Integer, List<ItemStack>> getPageMap() {return pageMap;}
     ...
     */
    @Override
    public void setPageMap(@Nullable HashMap<Integer, List<ItemStack>> pageMap) {this.pageMap = pageMap;}

    /**
     * @return Whether the player has a next page in their current menu interaction.
     */
    @Override
    public boolean hasNextPage() {return getPageMap().containsKey(getCurrentPage() + 1);}

    /**
     * @return Whether the player has a previous page in their current menu interaction.
     */
    @Override
    public boolean hasPreviousPage() {return getPageMap().containsKey(getCurrentPage() - 1);}
     ...
     */
    @Override
    public void setInteractionType(@Nullable InteractionType interactionType) {this.interactionType = interactionType;}
     ...
     */
    @Override
    public Object getInteractionValue() {return interactionValue;}
     ...
     */
    @Override
    public void setInteractionValue(@Nullable Object interactionValue) {this.interactionValue = interactionValue;}
     ...
     */
    @Override
    public Object getLongTermInteractionValue() {return longTermInteractionValue;}
     ...
     */
    @Override
    public void setLongTermInteractionValue(@Nullable Object longTermInteractionValue) {this.longTermInteractionValue = longTermInteractionValue;}
