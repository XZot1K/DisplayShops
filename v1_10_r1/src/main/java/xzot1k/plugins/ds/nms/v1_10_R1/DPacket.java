...
package xzot1k.plugins.ds.nms.v1_10_R1;
...
public class DPacket implements DisplayPacket {
    ...
    private net.minecraft.server.v1_10_R1.ItemStack itemStack;
            ...
            if (item.getType() != Material.AIR) {
                ...
                if (itemStack != null) {
                    ...
                    if (itemStack != null) {
                        ...
                        final DataWatcherSerializer<com.google.common.base.Optional<net.minecraft.server.v1_10_R1.ItemStack>> ITEM_STACK_SERIALIZER = DataWatcherRegistry.f;
                        ...
                        ITEM_STACK_SERIALIZER.a(metaData, com.google.common.base.Optional.fromNullable(itemStack));
                        metaData.d(0xFF);
