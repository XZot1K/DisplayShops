...
public class SUtil implements SerializeUtil {
    ...
    public ItemStack toItem(@NotNull String itemString) {
        ...
        if (!itemString.contains("item:"))
            try {
                ...
                return CraftItemStack.asBukkitCopy(net.minecraft.server.v1_10_R1.ItemStack.createStack(tag));
    ...
    public String toJSON(@NotNull ItemStack itemStack) {
        final net.minecraft.server.v1_10_R1.ItemStack item = CraftItemStack.asNMSCopy(itemStack);
