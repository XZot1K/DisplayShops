...
public class DPacket implements DisplayPacket {
    ...
    private net.minecraft.server.v1_13_R2.ItemStack itemStack;
            ...
            if (item.getType() != Material.AIR) {
                ...
                if (itemStack != null) {
                    ...
                    if (itemStack != null) {
                        ...
                        final DataWatcherSerializer<net.minecraft.server.v1_13_R2.ItemStack> ITEM_STACK_SERIALIZER = DataWatcherRegistry.g;
